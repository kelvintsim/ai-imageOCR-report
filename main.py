...
def process_image_file(image_file):
    """Handles the complete process for a single image file: upload, process, and clean data."""
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=5) as executor:
        future_to_image_file = {executor.submit(process_image_file, image_file): image_file for image_file in image_files}

        for future in as_completed(future_to_image_file):
            ...
            try:
                ...
                print(f"Image file {image_file} generated an exception: {exc}")
